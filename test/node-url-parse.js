...
describe('Url', function () {
    describe.only('parse()', function () {
        ...
        Object.keys(parseTests).forEach(function (test) {
            it('should be able to parse ' + test, function () {
                var actual = url.parse(test);
                var spaced = url.parse('     \t  ' + test + '\n\t');
                var expected = parseTests[test];
                ...
                expected = parseTests[test].href;
                actual = url.format(parseTests[test]);

                assert.equal(actual, expected, 'format(' + test + ') == ' + test + '\nactual:' + actual);
            });
        });

        describe.skip('With Query Strings', function () {
            ...
            Object.keys(parseTestsWithQueryString).forEach(function (test) {
                it('should be able to parse ' + test, function () {
                    var actual = url.parse(test, true);
                    var expected = parseTestsWithQueryString[test];
                    for (var i in actual) {
